  ...
  return (
    <div>
      <section className="py-8 bg-neutral-50 mb-40">
        <h2 className="text-center text-3xl font-bold md:text-5xl lg:text-left animate-fade-in-up transition-all duration-500 ease-in-out transform hover:translate-y-[-5px] hover:text-black text-blue-700">
        ...
        <p className="text-center m-4 mt-4 text-sm text-black sm:text-base md:mb-12 lg:mb-16 animate-fade-in-up delay-100">
          Join Kubra Rashid as she delves into the dynamic world of web
          ...
          developers in crafting stunning and functional websites. Explore,
          learn, and elevate your web development journey!
        </p>
