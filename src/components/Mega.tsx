...
export default function Mega() {
  const posts = [
    ...
    },
    {
      ...
      description:
        "Next.js is a React-based framework that simplifies building modern web applications by offering server-side rendering (SSR), static site generation (SSG).",
      date: "2024-12-29",
    ...
    },
    {
      ...
      description:
        "Python is a popular, high-level, interpreted programming language known for its simplicity, readability, and versatility.",
      date: "2024-12-29",
    ...
    },
    {
      ...
      description: "Explore the fundamental of HTML, the backbone of every web page.",
      date: "2024-12-29",
